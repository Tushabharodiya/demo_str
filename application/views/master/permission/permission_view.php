            ...
            <div class="nk-block-between">
                ...
                <div class="nk-block-head-content">
                    <div class="toggle-wrap nk-block-tools-toggle">
                        <a href="<?php echo base_url(); ?>view-permission" class="btn btn-icon btn-trigger toggle-expand me-n1" data-target="pageMenu"><em class="icon ni ni-menu-alt-r"></em></a>
            ...
            <div class="card-inner">
                <table class="datatable-init nk-tb-list nk-tb-ulist" data-auto-responsive="true">
                    ...
                    <tbody>
                        ...
                        <tr class="nk-tb-item">
                            <td class="nk-tb-col">
                                <span><?php echo $data['permission_position']; ?></span>
                            </td>
                            <td class="nk-tb-col">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <a href="<?php echo base_url(); ?>view-permission" class="close" data-bs-dismiss="modal" aria-label="Close">
