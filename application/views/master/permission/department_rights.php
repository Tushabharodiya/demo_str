<div class="nk-content-wrap">
    <div class="nk-block nk-block-lg">
        ...
        <?php $departmentID = $this->uri->segment(2); ?>
                                ...
                                <div class="col-md-4">
                                    <div id="accordion" class="accordion">
                                        <div class="accordion-item">
                                            <a href="<?php echo base_url(); ?>department-rights/<?php echo $departmentID; ?>" class="accordion-head collapsed" data-bs-toggle="collapse" data-bs-target="#accordion-item-<?php echo $data['alias_id']; ?>">
                                                                ...
                                                                <tr class="nk-tb-item">
                                                                    ...
                                                                    <td class="nk-tb-col nk-tb-col-check">
                                                                        <div class="custom-control custom-control-sm custom-checkbox ">
                                                                            <input type="checkbox" class="custom-control-input" id="<?php echo $data['permission_id']; ?>" name="department_permission[]" value="<?php echo $data['permission_id']; ?>" required
