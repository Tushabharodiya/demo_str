                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="form-control-wrap">
                                    ...
                                    <span class="text-danger"><?php if(!empty($this->session->userdata('session_charging_category_new_category_name'))){ ?> <?php echo $this->session->userdata('session_charging_category_new_category_name'); ?> <?php echo $this->session->unset_userdata('session_charging_category_new_category_name'); ?> <?php } ?></span>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12">
