                ...
                <div class="nk-block-head-content">
                    ...
                    <div class="nk-block-des text-soft">
                        <?php if($isAiChatDataView){ ?>
                            <p><?php echo "You have total $countAiChatDatas ai chat datas."; ?></p>
                        <?php } ?>
                    </div>
                </div>
                <div class="nk-block-head-content">
                    <div class="toggle-wrap nk-block-tools-toggle">
                        <a href="<?php echo base_url(); ?>view-ai-chat-datas/<?php echo $subCategoryID; ?>" class="btn btn-icon btn-trigger toggle-expand me-n1" data-target="pageMenu"><em class="icon ni ni-more-v"></em></a>
                        <div class="toggle-expand-content" data-content="pageMenu">
                            <ul class="nk-block-tools g-3">
                                <?php if($isAiChatDataView){ ?>
                                    <li>
                                        <div class="dropdown">
                                            <a href="<?php echo base_url(); ?>view-ai-chat-datas/<?php echo $subCategoryID; ?>" class="dropdown-toggle btn btn-white btn-dim btn-outline-light" data-bs-toggle="dropdown"><em class="d-none d-sm-inline icon ni ni-filter-alt"></em><span>Filtered By</span><em class="dd-indc icon ni ni-chevron-right"></em></a>
                                                    ...
                                                    <div class="row gx-6 gy-3">
                                                        <div class="col-12">
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control form-select" id="search-status" name="search_ai_chat_datas_status" data-id="<?php echo $subCategoryID; ?>" data-placeholder="Select a status">
                                                                    <?php $str='';
                                                                        if(!empty($sessionAiChatDatasStatus == 'all')){
                                                                            $str.='selected';
                                                                    } ?> <option value="all"<?php echo $str; ?>>All</option>
                                                                    <?php $str='';
                                                                        if(!empty($sessionAiChatDatasStatus == 'publish')){
                                                                            $str.='selected';
                                                                    } ?> <option value="publish"<?php echo $str; ?>>Publish</option>
                                                                    <?php $str='';
                                                                        if(!empty($sessionAiChatDatasStatus == 'unpublish')){
                                                                            $str.='selected';
                ...
                <form action="" method="post" class="form-validate is-alter" enctype="multipart/form-data">
                    <div class="form-group">
                        <div class="form-control-wrap">
                            <input type="text" class="form-control form-control-lg" name="search_ai_chat_datas" value="<?php if(!empty($sessionAiChatDatas)){ echo $sessionAiChatDatas; } ?>" placeholder="Search..." autocomplete="off">
                        ...
                        <div class="card-inner p-0">
                            <div class="table-responsive">
                                <table class="table table-tranx">
                                    ...
                                    <?php if($isAiChatDataView){ ?>
                                        <?php if(!empty($viewAiChatDatas)){ ?>
                                            <tbody>
                                                <?php foreach($viewAiChatDatas as $data){ ?>
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                ...
                                                                <a href="<?php echo base_url(); ?>view-ai-chat-datas/<?php echo $subCategoryID; ?>" class="close" data-bs-dismiss="modal" aria-label="Close">
                                                                    <em class="icon ni ni-cross"></em>
                                                                </a>
                                                            </div>
                                                            <div class="modal-body">
...
<script>
    document.getElementById('search-status').addEventListener('change', function() {
        ...
        $.ajax({
            url: '<?= base_url('view-ai-chat-datas'); ?>/' + subCategoryID,
            type: 'POST',
            data: { search_ai_chat_datas_status: selectedStatus },
            success: function() {
