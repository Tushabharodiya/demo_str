                    ...
                    <div class="row g-gs">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="form-control-wrap">
                                    ...
                                    <span class="text-danger"><?php if(!empty($this->session->userdata('session_ai_chat_main_category_new_main_category_name'))){ ?> <?php echo $this->session->userdata('session_ai_chat_main_category_new_main_category_name'); ?> <?php echo $this->session->unset_userdata('session_ai_chat_main_category_new_main_category_name'); ?> <?php } ?></span>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="form-control-wrap">
                                    <div class="form-file">
                                        <input type="file" class="form-control form-file-input" id="file-uploader" name="main_category_icon" required>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="form-control-wrap">
                                    <input type="text" class="form-control" name="main_category_title" placeholder="Enter main category title" required>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="form-control-wrap">
                                    <textarea type="text" class="form-control" name="main_category_description" placeholder="Enter main category description" required></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12">
