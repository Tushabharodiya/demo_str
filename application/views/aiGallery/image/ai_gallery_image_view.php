<?php
    $isAiGalleryImageNew = checkPermission(AI_GALLERY_IMAGE_ALIAS, "can_add");
    $isAiGalleryImageView = checkPermission(AI_GALLERY_IMAGE_ALIAS, "can_view");
    $isAiGalleryImageEdit = checkPermission(AI_GALLERY_IMAGE_ALIAS, "can_edit");
    $isAiGalleryImageDelete = checkPermission(AI_GALLERY_IMAGE_ALIAS, "can_delete");
    $isAiGalleryImagePublishEdit = checkPermission(AI_GALLERY_IMAGE_PUBLISH_ALIAS, "can_edit");
    $isAiGalleryImageUnpublishEdit = checkPermission(AI_GALLERY_IMAGE_UNPUBLISH_ALIAS, "can_edit");
    ...
    <div class="nk-block nk-block-lg">
        ...
        <div class="nk-block-head nk-block-head-sm">
            <div class="nk-block-between">
                <div class="nk-block-head-content">
                    <h4 class="nk-block-title page-title">AI Gallery Image</h4>
                    <div class="nk-block-des text-soft">
                        <?php if($isAiGalleryImageView){ ?>
                            <p><?php echo "You have total $countAiGalleryImage ai images."; ?></p>
                        <?php } ?>
                    </div>
                </div>
                <div class="nk-block-head-content">
                    <div class="toggle-wrap nk-block-tools-toggle">
                        <a href="<?php echo base_url(); ?>view-ai-gallery-image" class="btn btn-icon btn-trigger toggle-expand me-n1" data-target="pageMenu"><em class="icon ni ni-more-v"></em></a>
                        <div class="toggle-expand-content" data-content="pageMenu">
                            <ul class="nk-block-tools g-3">
                                <?php if($isAiGalleryImageView){ ?>
                                    <li>
                                        <div class="dropdown">
                                            <a href="<?php echo base_url(); ?>view-ai-gallery-image" class="dropdown-toggle btn btn-white btn-dim btn-outline-light" data-bs-toggle="dropdown"><em class="d-none d-sm-inline icon ni ni-filter-alt"></em><span>Filtered By</span><em class="dd-indc icon ni ni-chevron-right"></em></a>
                                            <div class="filter-wg dropdown-menu dropdown-menu-xl dropdown-menu-end">
                                                <div class="dropdown-head">
                                                    <span class="sub-title dropdown-title">Filter Ai Gallery Image</span>
                                                </div>
                                                <?php if($isAiGalleryImageEdit or $isAiGalleryImageDelete){ ?>
                                                    ...
                                                    <div class="row gx-6 gy-3">
                                                        <div class="col-6">
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control form-select" id="search-style" name="search_ai_gallery_image_style" data-placeholder="Select a style">
                                                                    <?php $str='';
                                                                        if(!empty($sessionAiGalleryImageStyle == 'all')){
                                                                            $str.='selected';
                                                                    } ?> <option value="all"<?php echo $str; ?>>All</option>
                                                                    <?php $str='';
                                                                        if(!empty($sessionAiGalleryImageStyle == 'enhance')){
                                                                            $str.='selected';
                                                                    } ?> <option value="enhance"<?php echo $str; ?>>Enhance</option>
                                                                    <?php $str='';
                                                                        if(!empty($sessionAiGalleryImageStyle == 'anime')){
                                                                            $str.='selected';
                                                                    } ?> <option value="anime"<?php echo $str; ?>>Anime</option>
                                                                    <?php $str='';
                                                                        if(!empty($sessionAiGalleryImageStyle == 'photographic')){
                                                                            $str.='selected';
                                                                    } ?> <option value="photographic"<?php echo $str; ?>>Photographic</option>
                                                                    <?php $str='';
                                                                        if(!empty($sessionAiGalleryImageStyle == 'digital-art')){
                                                                            $str.='selected';
                                                                    } ?> <option value="digital-art"<?php echo $str; ?>>Digital Art</option>
                                                                    <?php $str='';
                                                                        if(!empty($sessionAiGalleryImageStyle == 'comic-book')){
                                                                            $str.='selected';
                                                                    } ?> <option value="comic-book"<?php echo $str; ?>>Comic Book</option>
                                                                    <?php $str='';
                                                                        if(!empty($sessionAiGalleryImageStyle == 'fantasy-art')){
                                                                            $str.='selected';
                                                                    } ?> <option value="fantasy-art"<?php echo $str; ?>>Fantasy Art</option>
                                                                    <?php $str='';
                                                                        if(!empty($sessionAiGalleryImageStyle == 'line-art')){
                                                                            $str.='selected';
                                                                    } ?> <option value="line-art"<?php echo $str; ?>>Line Art</option>
                                                                    <?php $str='';
                                                                        if(!empty($sessionAiGalleryImageStyle == 'analog-film')){
                                                                            $str.='selected';
                                                                    } ?> <option value="analog-film"<?php echo $str; ?>>Analog Film</option>
                                                                    <?php $str='';
                                                                        if(!empty($sessionAiGalleryImageStyle == 'neon-punk')){
                                                                            $str.='selected';
                                                                    } ?> <option value="neon-punk"<?php echo $str; ?>>Neon Punk</option>
                                                                    <?php $str='';
                                                                        if(!empty($sessionAiGalleryImageStyle == 'isometric')){
                                                                            $str.='selected';
                                                                    } ?> <option value="isometric"<?php echo $str; ?>>Isometric</option>
                                                                    <?php $str='';
                                                                        if(!empty($sessionAiGalleryImageStyle == 'low-poly')){
                                                                            $str.='selected';
                                                                    } ?> <option value="low-poly"<?php echo $str; ?>>Low Poly</option>
                                                                    <?php $str='';
                                                                        if(!empty($sessionAiGalleryImageStyle == 'origami')){
                                                                            $str.='selected';
                                                                    } ?> <option value="origami"<?php echo $str; ?>>Origami</option>
                                                                    <?php $str='';
                                                                        if(!empty($sessionAiGalleryImageStyle == 'modeling-compound')){
                                                                            $str.='selected';
                                                                    } ?> <option value="modeling-compound"<?php echo $str; ?>>Modeling</option>
                                                                    <?php $str='';
                                                                        if(!empty($sessionAiGalleryImageStyle == 'cinematic')){
                                                                            $str.='selected';
                                                                    } ?> <option value="cinematic"<?php echo $str; ?>>Cinematic</option>
                                                                    <?php $str='';
                                                                        if(!empty($sessionAiGalleryImageStyle == '3d-model')){
                                                                            $str.='selected';
                                                                    } ?> <option value="3d-model"<?php echo $str; ?>>3d Model</option>
                                                                    <?php $str='';
                                                                        if(!empty($sessionAiGalleryImageStyle == 'pixel-art')){
                                                                            $str.='selected';
                                                                    } ?> <option value="pixel-art"<?php echo $str; ?>>Pixel Art</option>
                                                                    <?php $str='';
                                                                        if(!empty($sessionAiGalleryImageStyle == 'tile-texture')){
                                                                            $str.='selected';
                                                        ...
                                                        <div class="col-6">
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control form-select" id="search-size" name="search_ai_gallery_image_size" data-placeholder="Select a size">
                                                                    <?php $str='';
                                                                        if(!empty($sessionAiGalleryImageSize == 'all')){
                                                                            $str.='selected';
                                                                    } ?> <option value="all"<?php echo $str; ?>>All</option>
                                                                    <?php $str='';
                                                                        if(!empty($sessionAiGalleryImageSize == '1024x1024')){
                                                                            $str.='selected';
                                                                    } ?> <option value="1024x1024"<?php echo $str; ?>>1024x1024</option>
                                                                    <?php $str='';
                                                                        if(!empty($sessionAiGalleryImageSize == '2048x2048')){
                                                                            $str.='selected';
                                                                    } ?> <option value="2048x2048"<?php echo $str; ?>>2048x2048</option>
                                                                    <?php $str='';
                                                                        if(!empty($sessionAiGalleryImageSize == '1152x896')){
                                                                            $str.='selected';
                                                                    } ?> <option value="1152x896"<?php echo $str; ?>>1152x896</option>
                                                                    <?php $str='';
                                                                        if(!empty($sessionAiGalleryImageSize == '1216x832')){
                                                                            $str.='selected';
                                                                    } ?> <option value="1216x832"<?php echo $str; ?>>1216x832</option>
                                                                    <?php $str='';
                                                                        if(!empty($sessionAiGalleryImageSize == '1344x768')){
                                                                            $str.='selected';
                                                                    } ?> <option value="1344x768"<?php echo $str; ?>>1344x768</option>
                                                                    <?php $str='';
                                                                        if(!empty($sessionAiGalleryImageSize == '1536x640')){
                                                                            $str.='selected';
                                                                    } ?> <option value="1536x640"<?php echo $str; ?>>1536x640</option>
                                                                    <?php $str='';
                                                                        if(!empty($sessionAiGalleryImageSize == '640x1536')){
                                                                            $str.='selected';
                                                                    } ?> <option value="640x1536"<?php echo $str; ?>>640x1536</option>
                                                                    <?php $str='';
                                                                        if(!empty($sessionAiGalleryImageSize == '768x1344')){
                                                                            $str.='selected';
                                                                    } ?> <option value="768x1344"<?php echo $str; ?>>768x1344</option>
                                                                    <?php $str='';
                                                                        if(!empty($sessionAiGalleryImageSize == '832x1216')){
                                                                            $str.='selected';
                                                                    } ?> <option value="832x1216"<?php echo $str; ?>>832x1216</option>
                                                                    <?php $str='';
                                                                        if(!empty($sessionAiGalleryImageSize == '896x1152')){
                                                                            $str.='selected';
                                                        ...
                                                        <div class="col-6">
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control form-select" id="search-show" name="search_ai_gallery_image_show" data-placeholder="Select a show">
                                                                    <?php $str='';
                                                                        if(!empty($sessionAiGalleryImageShow == 'all')){
                                                                            $str.='selected';
                                                                    } ?> <option value="all"<?php echo $str; ?>>All</option>
                                                                    <?php $str='';
                                                                        if(!empty($sessionAiGalleryImageShow == 'public')){
                                                                            $str.='selected';
                                                                    } ?> <option value="public"<?php echo $str; ?>>Public</option>
                                                                    <?php $str='';
                                                                        if(!empty($sessionAiGalleryImageShow == 'private')){
                                                                            $str.='selected';
                                                        ...
                                                        <div class="col-6">
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control form-select" id="search-status" name="search_ai_gallery_image_status" data-placeholder="Select a status">
                                                                    <?php $str='';
                                                                        if(!empty($sessionAiGalleryImageStatus == 'all')){
                                                                            $str.='selected';
                                                                    } ?> <option value="all"<?php echo $str; ?>>All</option>
                                                                    <?php $str='';
                                                                        if(!empty($sessionAiGalleryImageStatus == 'publish')){
                                                                            $str.='selected';
                                                                    } ?> <option value="publish"<?php echo $str; ?>>Publish</option>
                                                                    <?php $str='';
                                                                        if(!empty($sessionAiGalleryImageStatus == 'unpublish')){
                                                                            $str.='selected';
                ...
                <form action="" method="post" class="form-validate is-alter" enctype="multipart/form-data">
                    <div class="form-group">
                        <div class="form-control-wrap">
                            <input type="text" class="form-control form-control-lg" name="search_ai_gallery_image" value="<?php if(!empty($sessionAiGalleryImage)){ echo $sessionAiGalleryImage; } ?>" placeholder="Search..." autocomplete="off">
        ...
        <div class="nk-block">
            <form id="myForm" action="" method="post" class="form-validate is-alter" enctype="multipart/form-data">
                    ...
                    <div class="modal-dialog modal-dialog-top" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <a href="<?php echo base_url(); ?>view-ai-gallery-image" class="close" data-bs-dismiss="modal" aria-label="Close">
                ...
                <div class="row g-gs">
                    <?php if($isAiGalleryImageView){ ?>
                        <?php if(!empty($viewAiGalleryImage)){ ?>
                            <?php foreach($viewAiGalleryImage as $data){ ?>
                                            ...
                                            <div class="pricing-action">
                                                <div class="team-view">
                                                    <?php if($data['image_status'] == "publish"){ ?>
                                                        <?php if($isAiGalleryImageUnpublishEdit){ ?>
                                                        ...
                                                        <?php } ?>
                                                    <?php } else { ?>
                                                        <?php if($isAiGalleryImagePublishEdit){ ?>
                                                            <li class="nk-tb-action">
...
<script>
    document.getElementById('search-style').addEventListener('change', function() {
        ...
        $.ajax({
            url: '<?= base_url('view-ai-gallery-image'); ?>',
            type: 'POST',
            data: { search_ai_gallery_image_style: selectedStyle },
            success: function() {
                location.reload();
            }
        });
...
<script>
    document.getElementById('search-size').addEventListener('change', function() {
        ...
        $.ajax({
            url: '<?= base_url('view-ai-gallery-image'); ?>',
            type: 'POST',
            data: { search_ai_gallery_image_size: selectedSize },
            success: function() {
                location.reload();
            }
        });
...
<script>
    document.getElementById('search-show').addEventListener('change', function() {
        ...
        $.ajax({
            url: '<?= base_url('view-ai-gallery-image'); ?>',
            type: 'POST',
            data: { search_ai_gallery_image_show: selectedShow },
            success: function() {
                location.reload();
            }
        });
...
<script>
    document.getElementById('search-status').addEventListener('change', function() {
        ...
        $.ajax({
            url: '<?= base_url('view-ai-gallery-image'); ?>',
            type: 'POST',
            data: { search_ai_gallery_image_status: selectedStatus },
            success: function() {
