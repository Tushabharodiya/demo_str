                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="form-control-wrap">
                                    ...
                                    <span class="text-danger"><?php if(!empty($this->session->userdata('session_ai_gallery_category_new_category_name'))){ ?> <?php echo $this->session->userdata('session_ai_gallery_category_new_category_name'); ?> <?php echo $this->session->unset_userdata('session_ai_gallery_category_new_category_name'); ?> <?php } ?></span>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="form-control-wrap">
                                    <div class="form-file">
                                        <input type="file" class="form-control form-file-input" id="file-uploader" name="category_icon" required>
